<?php get_header();
$content_class = '';
$evl_portfolio_layout_archive_category = evolve_get_option('evl_portfolio_layout_archive_category');
$evl_width_px = evolve_get_option('evl_width_px');
$evl_portfolio_sidebar = evolve_get_option('evl_portfolio_sidebar');
...
$evl_portfolio_sidebar = evolve_get_option('evl_portfolio_sidebar');
$evl_portfolio_sidebar_position = evolve_get_option('evl_portfolio_sidebar_position');
