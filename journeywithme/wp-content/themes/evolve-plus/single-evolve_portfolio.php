...
<div id="content" class="portfolio-<?php echo $portfolio_width; ?> <?php echo $class; ?>" style="<?php echo $content_css; ?>">
	...
	$evl_portfolio_disable_pagination = evolve_get_option('evl_portfolio_disable_pagination');	
	?>
    ...
    <?php if (have_posts()): the_post(); ?>
        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <?php
            $full_image = '';
			$evl_portfolio_featured_image_video = evolve_get_option('evl_portfolio_featured_image_video');
            ...
            <div class="project-content">
                ...
                <?php if (!post_password_required($post->ID)): ?>        
                    <div class="project-info" style="<?php echo $project_info_style; ?>">
                        ...
                        <?php endif; ?>
                        <?php 						
						$evl_portfolio_author = evolve_get_option('evl_portfolio_author');
            ...
            <?php if (!post_password_required($post->ID)): ?> 
                <?php				
				$evl_portfolio_sharing_box = evolve_get_option('evl_portfolio_sharing_box');
