...
if (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 1200) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-two-page portfolio-two-text';
    $sidebar_exists = false;
    ...
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page col-md-8 col-md-push-4';
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
} elseif (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 1600) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-two-page portfolio-two-page portfolio-two-text portfolio-two-text-1600';
    $sidebar_exists = false;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page portfolio-two-sidebar-page-1600 col-md-8 col-md-push-4';
    $sidebar_class = 'col-md-4 col-md-pull-8';
    $sidebar_exists = true;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page portfolio-two-sidebar-page-1600 col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
} elseif (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 985) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-two-page portfolio-two-text portfolio-two-text-985';
    $sidebar_exists = false;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page portfolio-two-sidebar-page-985 col-md-8 col-md-push-4';
    $sidebar_class = 'col-md-4 col-md-pull-8';
    $sidebar_exists = true;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page portfolio-two-sidebar-page-985 col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
} elseif (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 800) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-two-page portfolio-two-text portfolio-two-text-800';
    $sidebar_exists = false;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page portfolio-two-sidebar-page-800 col-md-8 col-md-push-4';
    $sidebar_class = 'col-md-4 col-md-pull-8';
    $sidebar_exists = true;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-two-page portfolio-two-text portfolio-two-sidebar-page portfolio-two-sidebar-page-800 col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
}
?>
