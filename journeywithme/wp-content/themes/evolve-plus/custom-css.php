...
$evolve_sticky_header_logo = evolve_get_option('evl_sticky_header_logo', '');
$evolve_sticky_header_logo_size = evolve_get_option('evl_sticky_header_logo_size', '');
...
$evolve_woocommerce_one_page_checkout = evolve_get_option('evl_woocommerce_one_page_checkout', '0');
...
// Theme4press Core Shortcodes
$evolve_shortcode_content_box_color = evolve_get_option('evl_shortcode_content_box_color');
$evolve_shortcode_counter_boxes_color = evolve_get_option('evl_shortcode_counter_boxes_color');
$evolve_shortcode_counter_boxes_shadow = evolve_get_option('evl_shortcode_counter_boxes_shadow');
$evolve_shortcode_flip_boxes_heading_color_frontside = evolve_get_option('evl_shortcode_flip_boxes_heading_color_frontside');
$evolve_shortcode_flip_heading_color_backside = evolve_get_option('evl_shortcode_flip_heading_color_backside');
$evolve_shortcode_pricing_style_1_heading_color = evolve_get_option('evl_shortcode_pricing_style_1_heading_color');
$evolve_shortcode_pricing_style_2_heading_color = evolve_get_option('evl_shortcode_pricing_style_2_heading_color');
$evolve_shortcode_pricing_box_color = evolve_get_option('evl_shortcode_pricing_box_color');
$evolve_shortcode_pricing_box_border_color = evolve_get_option('evl_shortcode_pricing_box_border_color');
$evolve_shortcode_accordion_inactive_box_color = evolve_get_option('evl_shortcode_accordion_inactive_box_color');
$evolve_shortcode_title_sep_color = evolve_get_option('evl_shortcode_title_sep_color');
$evolve_shortcode_person_border_size = evolve_get_option('evl_shortcode_person_border_size');
$evolve_shortcode_person_border_color = evolve_get_option('evl_shortcode_person_border_color');
$evolve_shortcode_tabs_bg_color = evolve_get_option('evl_shortcode_tabs_bg_color');


// Theme4press Core Shortcode Custom Styling
if ($evolve_shortcode_counter_boxes_shadow == '1') {
    $evolve_css_data .= '
...
$evolve_css_data .= '
.content-boxes .col { 
	background-color:' . $evolve_shortcode_content_box_color . ';
}
...
.full-boxed-pricing.t4p-pricing-table .panel-heading h3{
	color:' . $evolve_shortcode_pricing_style_2_heading_color . ' !important;
}

.sep-boxed-pricing .panel-heading, 
.sep-boxed-pricing .pricing-row {
  background-color:' . $evolve_shortcode_pricing_box_color . ' !important;
}

.sep-boxed-pricing .panel-container,
.full-boxed-pricing {
	border-color:' . $evolve_shortcode_pricing_box_border_color . ' !important;
}

.t4p-accordian .panel-heading{
  background-color:' . $evolve_shortcode_accordion_inactive_box_color . ';
}

.t4p-title .title-sep {
	border-color:' . $evolve_shortcode_title_sep_color . '!important;
}

.person-img, .person-imgage-container img{
	border: '. $evolve_shortcode_person_border_size.' solid ' . $evolve_shortcode_person_border_color .';
}


';
// End Theme4press Core Shortcode Custom Styling
...
.entry-content .read-more a,  .t4p-blog-shortcode .entry-read-more a,
#page-links a,
...
.order-dropdown .current-li,.products li {
	border-color:#505050;
}
...
.evolve-select-parent #billing_country_chosen, 
...
.products-slider .price ins .amount,
.simple-products-slider .price > .amount, 
.simple-products-slider .price ins .amount{
	color: #333;
}
...
.woocommerce form.checkout .evolve-checkout-no-shipping #customer_details .col-1 {
	width:100%;
	margin-right:0;
}
	
.woocommerce form.checkout .evolve-checkout-no-shipping #customer_details .col-2 {
	display:none;
}
	';
