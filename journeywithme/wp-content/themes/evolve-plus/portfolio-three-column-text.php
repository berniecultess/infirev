...
$evl_width_px = evolve_get_option('evl_width_px');
if (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 1200) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-three-page portfolio-three-text';
    $sidebar_exists = false;
    ...
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page col-md-8 col-md-push-4';
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
} elseif (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 1600) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-three-page portfolio-three-page portfolio-three-text portfolio-three-text-1600';
    $sidebar_exists = false;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page portfolio-three-sidebar-page-1600 col-md-8 col-md-push-4';
    $sidebar_class = 'col-md-4 col-md-pull-8';
    $sidebar_exists = true;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page portfolio-three-sidebar-page-1600 col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
} elseif (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 985) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-three-page portfolio-three-text portfolio-three-text-985';
    $sidebar_exists = false;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page portfolio-three-sidebar-page-985 col-md-8 col-md-push-4';
    $sidebar_class = 'col-md-4 col-md-pull-8';
    $sidebar_exists = true;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page portfolio-three-sidebar-page-985 col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
} elseif (get_post_meta($post->ID, 'pyre_portfolio_full_width', true) == 'yes' && $evl_width_px == 800) {
    $content_css = 'width:100%';
    $sidebar_css = 'display:none';
	$content_class = 'portfolio-three-page portfolio-three-text portfolio-three-text-800';
    $sidebar_exists = false;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page portfolio-three-sidebar-page-800 col-md-8 col-md-push-4';
    $sidebar_class = 'col-md-4 col-md-pull-8';
    $sidebar_exists = true;
    ...
    $content_css = 'display:block;';
    $sidebar_css = 'display:block;';
    $content_class = 'portfolio-three-page portfolio-three-text portfolio-three-sidebar-page portfolio-three-sidebar-page-800 col-md-8';
    $sidebar_class = 'col-md-4';
    $sidebar_exists = true;
}
?>
<div id="content" class="portfolio-template portfolio portfolio-three <?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
	...
	$evl_portfolio_no_item_per_page = evolve_get_option('evl_portfolio_no_item_per_page');
    $args = array(
                ...
                while ($gallery->have_posts()): $gallery->the_post();
                    ...
                    if (has_post_thumbnail() || get_post_meta($post->ID, 'pyre_video', true)):
                        ...
                        <div class="portfolio-item <?php echo $item_classes; ?>">
                            ...
                            <?php endif; ?>
                            <div class="portfolio-content three">
								...
								<div class="buttons">
                                    <a href="<?php echo $permalink; ?>" class="<?php echo sprintf('read-more btn btn-default button medium t4p-button button-medium button-default button-%s button-%s', strtolower($evl_options['evl_shortcode_button_shape']), strtolower($evl_options['evl_shortcode_button_type'])); ?>"><?php echo __('Learn More', 'evolve'); ?></a>            
