...
Redux::setArgs($opt_name, array(
    ...
    'display_name' => '<img width="128" height="34" src="' . get_template_directory_uri() . '/library/functions/images/logo.jpg" alt="evolve">',
...
array(
    ...
    'subsection' => true,	
    'style' => 'warning',
    'desc'  => '<div class="spinner"></div> '.__('Importing the demo content. Please don\'t leave/refresh the page until it\'s imported', 'evolve')
),	
        array(
