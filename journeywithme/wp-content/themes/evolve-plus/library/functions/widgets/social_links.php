...
class Social_Links_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
		'social_links-widget',
        __( 'evolve: Social Links', 'evolve' ), // Name
    ...
    $nofollow_social_links = evolve_get_option('evl_nofollow_social_links','0');
		...
		?>
	  <?php $boxed_icons = ''; if( isset ( $instance['boxed_icon'] ) && $instance['boxed_icon'] == 'Yes' && isset( $instance['boxed_color'] ) && $instance['boxed_color'] ) {
    ...
    ?>       
			<div class="t4p-social-networks-widget t4p-social-networks<?php echo $boxed_icons; ?>">
			<?php
			...
			?>
			<span class="t4p-icon-holder"><a class="t4p-social-network-icon t4p-tooltip t4p-<?php echo $value; ?> t4p-icon-<?php echo $value; ?>" href="<?php echo $instance[$name]; ?>" data-placement="<?php echo strtolower( $instance['tooltip_pos'] ); ?>" data-title="<?php echo ucwords( $value ); ?>" data-toggle="tooltip" data-original-title="" title="" <?php echo $nofollow; ?> target="<?php echo $instance['linktarget']; ?>" style="<?php echo $style; ?>"></a></span>
			<?php
				endif;
			endforeach;
			?>
