...
// end __construct();
        ...
        function before_container() {
            ...
            $content_css = '';
            if (class_exists('Woocommerce') || (get_post_meta($post->ID, 'evolve_full_width', true) == 'yes')):
                if ((get_post_meta($post->ID, 'evolve_full_width', true) == 'yes') || is_cart() || is_checkout() || is_account_page() || (get_option('woocommerce_thanks_page_id') && is_page(get_option('woocommerce_thanks_page_id')))) {
