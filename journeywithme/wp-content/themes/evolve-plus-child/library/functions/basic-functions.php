                ...
                <ul class="slides" style="width:<?php echo $slider_settings['slider_width']; ?>; margin-left: 0px;">
                    ...
                    while ($query->have_posts()): $query->the_post();
                        ...
                        if (isset($metadata['pyre_heading_font_size'][0]) && $metadata['pyre_heading_font_size'][0]) {
                            ...
                            $heading_font_size = 'font-size:' . $metadata['pyre_heading_font_size'][0] . 'px !important;line-height:' . $line_height . 'px !important;';
                        }
                            ...
                            ?>">
                                <div class="slide-content">
                                    <?php if (isset($metadata['pyre_heading'][0]) && $metadata['pyre_heading'][0]): ?>
                                        ...
                                        ?>" data-animationtype="fadeInUp" data-animationduration="1"><h2 style="<?php echo $heading_bg; ?><?php echo $heading_color; ?><?php echo $heading_font_size; ?>"><?php echo $metadata['pyre_heading'][0]; ?></h2></div>
                                         <?php endif; ?>
                                        ...
                                        ?>" data-animationtype="fadeInUp" data-animationduration="1"><h3 style="<?php echo $caption_bg; ?><?php echo $caption_color; ?><?php echo $caption_font_size; ?>"><?php echo $metadata['pyre_caption'][0]; ?></h3></div>
                                         <?php endif; ?>
...
function evolve_footer_hooks() {
    ...
    <?php if (!$status_vimeo): ?>$f(slider.slides.eq(slider.currentSlide).find('iframe')[0]).api('pause');<?php endif; ?>
	...
	if( $pages == '' ) {
     ...
     if(1 != $pages)
     {
        ...
        //}
         ...
         if($paged > 1) echo "<a class='pagination-prev' href='".get_pagenum_link($paged - 1)."'><span class='page-prev'></span>".__('Previous', 'evolve')."</a>";
         ...
         if ($paged < $pages) echo "<a class='pagination-next' href='".get_pagenum_link($paged + 1)."'>".__('Next', 'evolve')."<span class='page-next'></span></a>";  
