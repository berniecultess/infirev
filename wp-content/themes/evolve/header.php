...
<div id="wrapper" class="transparency">
<?php } ?>
...
<?php $evolve_menu_background = evolve_get_option('evl_disable_menu_back','1'); $evolve_width_layout = evolve_get_option('evl_width_layout','fixed'); if ( $evolve_width_layout == "fluid" && $evolve_menu_background == "1" ) { ?>
	...
	<?php } ?>
		...
		<div class="menu-header">
			...
			<?php $evolve_main_menu = evolve_get_option('evl_main_menu','0'); ?>
			<!--BEGIN .container-menu-->
			<div class="container nacked-menu container-menu" <?php if ($evolve_main_menu == "1"): echo "style='display:none;'"; endif;?>>
			
			<?php if ($evolve_main_menu == "1") { ?>
			<br /><br />
